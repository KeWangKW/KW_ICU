...
//        static var barStyle = "KWNavigationBarKeys_barStyle"
        static var statusBarStyle = "KWNavigationBarKeys_statusBarStyle"
...
//    }
    //MARK: 状态栏样式，默认样式
    ///状态栏样式
    @objc var kw_statusBarStyle : UIStatusBarStyle {
        get {
            //return objc_getAssociatedObject(self, &KWNavigationBarKeys.statusBarStyle) as? UIStatusBarStyle ?? .default
            let style:UIStatusBarStyle = objc_getAssociatedObject(self, &KWNavigationBarKeys.statusBarStyle) as? UIStatusBarStyle ?? .default
            self.navigationController?.KWChangeStatusBarStyle(style)
            return .default
        }
        set {
            //objc_setAssociatedObject(self, &KWNavigationBarKeys.statusBarStyle, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
            //setNeedsStatusBarAppearanceUpdate()
            self.navigationController?.KWChangeStatusBarStyle(newValue)
        }
    }
    ...
    //MARK: 导航栏标题文字颜色，默认黑色
    ///title颜色 默认黑色
    @objc var kw_titleColor: UIColor {
        get {
    ...
    //MARK: 导航栏背景色，默认白色
    ///导航栏背景色，默认白色
    @objc var kw_backgroundColor: UIColor {
        get {
    ...
    //MARK: 导航栏背景图片
    ///导航栏背景图片
    @objc var kw_backgroundImage: UIImage? {
        get {
    ...
    //MARK: 导航栏底部分割线颜色
    ///导航栏底部分割线颜色
    @objc var kw_shadowColor: UIColor {
        get {
    ...
    //MARK: 是否开启手势返回，默认开启
    ///是否开启手势返回，默认开启
    @objc var kw_enablePopGesture: Bool {
        get {
